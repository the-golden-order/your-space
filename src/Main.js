...
//  }
  ...
  render() {
    ...
    let allResults = this.props.itunesAPI.map((query, index) => {
      return (
        <MainCard
          key={index}
          query={query} 
    ...
    return (
      <>
        <Container>
          <SearchBar getItunesData={this.props.getItunesData} handleMusicInput={this.props.handleMusicInput} />  
        </Container>
        ...
        <UserProfile music={this.props.music}/>
